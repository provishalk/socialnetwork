  ...
  return (
    <Navbar bg="dark" expand="lg">
      <Container>
        <Navbar.Brand>
          <Link
            to={isLoggedIn ? HOME_PATH : LOGIN_PATH}
            className="text-decoration-none text-secondary navbar_brand-name"
          >
            {LOGO}
          </Link>
        </Navbar.Brand>
          ...
          <Nav>
            ...
            >
              <Link
                ...
                className="text-decoration-none text-secondary navbar_dropdown_link"
              >
